...
\begin{frame}{图片}
    \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{bk_logo.png}
        \caption{北京科技大学}\label{fig:nk}
    \end{figure}
\end{frame}
...
\begin{frame}{分栏}
    \begin{columns}
        \begin{column}{0.3\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.95\textwidth]{bk_logo.png}
                \caption{USTB}\label{fig:nku}
            \end{figure}
        \end{column}
...
\begin{frame}{Subfigure}
    \begin{figure}
        \centering
        \subfigure[]{\includegraphics[width=0.47\textwidth]{bk_logo.png}}
        \subfigure[]{\includegraphics[width=0.47\textwidth]{bkbackground.png}}
